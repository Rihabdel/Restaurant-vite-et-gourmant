...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    {
        return $this->contactMsgs;
    }

    public function addContactMsg(ContactMsg $contactMsg): static
    {
        if (!$this->contactMsgs->contains($contactMsg)) {
            $this->contactMsgs->add($contactMsg);
            $contactMsg->setUser($this);
        }
